...
import { officerAuth, insertBill, checkAllBill, updateBill, deleteBill } from '../controllers/officer.js';
...
router.get('/officer/check-bill', checkOfficerAuth, checkAllBill);
